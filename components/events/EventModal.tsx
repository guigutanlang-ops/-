...
const EventModal: React.FC<Props> = ({ event, onChoice }) => {
    ...
    return createPortal(
        <div className="absolute inset-0 z-[9000] flex items-center justify-center bg-bg-main/95 p-12 animate-fade-in pointer-events-auto" onWheel={(e) => e.stopPropagation()}>
